 ...
 * @author nursalim
 */
public class FrmDaftarJamaah extends javax.swing.JDialog {
    ...
    public FrmDaftarJamaah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/simtravel/image/jamaah40.png"))); // NOI18N
        jLabel1.setText("Daftar Jamaah");
    ...
    private void tambahBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahBtnActionPerformed
        ...
        Map data = new HashMap();
        data.put("action", "tambah");
        new FrmTambahJamaah(null, true, data).setVisible(true);
    ...
    private void exportWordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exportWordMouseClicked
        try {
            ...
            Logger.getLogger(FrmDaftarJamaah.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDaftarJamaah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDaftarJamaah dialog = new FrmDaftarJamaah(new javax.swing.JFrame(), true);
